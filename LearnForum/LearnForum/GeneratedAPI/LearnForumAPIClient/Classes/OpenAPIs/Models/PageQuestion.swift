...
public struct PageQuestion: Codable, JSONEncodable, Hashable {
    ...
    public var records: [Question]?
    public var searchCount: Bool?
    public var size: Int64?
    public var total: Int64?

    public init(countId: String? = nil, current: Int64? = nil, maxLimit: Int64? = nil, optimizeCountSql: Bool? = nil, orders: [OrderItem]? = nil, pages: Int64? = nil, records: [Question]? = nil, searchCount: Bool? = nil, size: Int64? = nil, total: Int64? = nil) {
