...
public struct PagePostVO: Codable, JSONEncodable, Hashable {
    ...
    public var records: [PostVO]?
    public var searchCount: Bool?
    public var size: String?
    public var total: String?

    public init(countId: String? = nil, current: String? = nil, maxLimit: Int64? = nil, optimizeCountSql: Bool? = nil, orders: [OrderItem]? = nil, pages: String? = nil, records: [PostVO]? = nil, searchCount: Bool? = nil, size: String? = nil, total: String? = nil) {
