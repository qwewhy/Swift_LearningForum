...
public struct PageUser: Codable, JSONEncodable, Hashable {
    ...
    public var records: [User]?
    public var searchCount: Bool?
    public var size: Int64?
    public var total: Int64?

    public init(countId: String? = nil, current: String? = nil, maxLimit: Int64? = nil, optimizeCountSql: Bool? = nil, orders: [OrderItem]? = nil, pages: Int64? = nil, records: [User]? = nil, searchCount: Bool? = nil, size: Int64? = nil, total: Int64? = nil) {
