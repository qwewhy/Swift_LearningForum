...
public struct PageUserVO: Codable, JSONEncodable, Hashable {
    ...
    public var records: [UserVO]?
    public var searchCount: Bool?
    public var size: Int64?
    public var total: Int64?

    public init(countId: String? = nil, current: String? = nil, maxLimit: Int64? = nil, optimizeCountSql: Bool? = nil, orders: [OrderItem]? = nil, pages: Int64? = nil, records: [UserVO]? = nil, searchCount: Bool? = nil, size: Int64? = nil, total: Int64? = nil) {
