...
public struct PageUserVO: Codable, JSONEncodable, Hashable {
    ...
    public init(countId: String? = nil, current: Int64? = nil, maxLimit: Int64? = nil, optimizeCountSql: Bool? = nil, orders: [OrderItem]? = nil, pages: Int64? = nil, records: [UserVO]? = nil, searchCount: Bool? = nil, size: Int64? = nil, total: Int64? = nil) {
