...
public struct PageQuestionBankVO: Codable, JSONEncodable, Hashable {
    ...
    public var records: [QuestionBankVO]?
    public var searchCount: Bool?
    public var size: String?
    public var total: Int64?

    public init(countId: String? = nil, current: String? = nil, maxLimit: Int64? = nil, optimizeCountSql: Bool? = nil, orders: [OrderItem]? = nil, pages: String? = nil, records: [QuestionBankVO]? = nil, searchCount: Bool? = nil, size: String? = nil, total: Int64? = nil) {
