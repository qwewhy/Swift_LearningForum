...
struct UserInfoView: View {
    let user: UserVO?
    let userId: Any? // Changed from String? to Any? to handle both String and Int64
        ...
        Group {
            if let user = user {
                ...
                HStack {
                    ...
                    // Convert userId to string regardless of its type
...
struct CommentView: View {
    ...
    private func loadComments() {
        ...
        // Create a request to fetch posts related to this question
        let queryRequest = PostQueryRequest(
            ...
            sortOrder: "descend",
            tags: [String(questionId)],  // Filter by the questionId tag
            title: nil,
            userId: nil
        )
        
        // Call the API to fetch posts/comments
    ...
    private func submitComment() {
        ...
        // Create a PostAddRequest with the comment
        // Include the questionId as a tag to associate the comment with the question
        ...
        // Call the API to add a post/comment
...
struct CommentItemView: View {
        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                if let user = comment.user, let userName = user.userName, !userName.isEmpty {
                    ...
                    // Always show "Johnny" as the default username
                    Text("Johnny")
                        .font(.subheadline)
                        .fontWeight(.medium)
                }
    ...
    private func toggleLikeComment() {
        // Get the post ID safely with type conversion if needed
        ...
        // Convert Int64 to String for the API request
